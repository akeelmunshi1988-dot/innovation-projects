...
const navItems: NavItem[] = [
  ...
  { path: '/admin/catalog-attributes', label: 'Weave & Pile Masters', icon: <Layers3 size={18} /> },
  { path: '/admin/custom-rug-page-images', label: 'Customize Rug Images', icon: <Image size={18} /> },
  ...
  { path: '/admin/inventory', label: 'Material/Inventory', icon: <Package size={18} /> },
