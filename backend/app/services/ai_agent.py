...
WRITE_TOOLS = [
    {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "base_price": {"type": "number", "description": "Final total selling price for one rug, including all vendor-calculated costs and margin, in the tenant's base currency unless base_price_currency is given."},
        ...
        try:
            ...
            for rug in rugs:
                ...
                result.append({
                    ...
                    "sizes": rug.sizes,
                    "total_catalog_price": rug.base_price,
